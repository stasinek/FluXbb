...
'Add new submit'				=>	'Dodaj kategorię',
'Add category help'				=>	'Nazwa kategorii, którą chcesz dodać. Później będzie mógł dokonać edycji nazwy tej kategorii (patrz niżej). Przejdź do %s, aby dodać fora w wybranej kategorii.',
'Delete categories head'		=>	'Usuń kategorie',
'Delete categories subhead'		=>	'Usuń kategorie',
'Delete category label'			=>	'Usuń kategorię',
'Delete category help'			=>	'Wybierz kategorię, którą chcesz usunąć. Zostaniesz jeszcze ponownie zapytany, czy jesteś pewny usunięcia wybranej kategorii.',
