...
'Quick search show_user_topics'		=>	'tematy napisane przez %s',
'Quick search show_user_posts'		=>	'posty napisane przez %s',
'Quick search show_subscriptions'	=>	'subskrybowane przez %s',
'By keywords show as topics'		=>	'tematy z postami ze słowami kluczowymi \'%s\'',
'By keywords show as posts'			=>	'posty ze słowami kluczowymi \'%s\'',
'By user show as topics'			=>	'tematy z postami użytkownika %s',
'By user show as posts'				=>	'posty napisane przez %s',
'By both show as topics'			=>	'tematy ze słowami kluczowymi \'%s\' w postach użytkownika %s',
...
'No user topics'					=>	'Na forum nie ma żadnych tematów tego użytkownika.',
'No subscriptions'					=>	'Użytkownik aktualnie nie subskrybuje żadnych tematów.',
...
'No unanswered'						=>	'Na forum nie ma żadnych tematów bez odpowiedzi.',
