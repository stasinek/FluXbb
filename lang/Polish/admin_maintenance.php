...
'No old topics message'         =>  'Na forum nie ma tematów z postami starszymi niż %s dni. Zmniejsz wartość w polu "Ilość dni wstecz" i spróbuj ponownie.',
'Posts pruned redirect'         =>  'Forum zostało wyczyszczone. Przekierowywanie…',
'Prune head'                    =>  'Czyszczenie forum',
'Prune subhead'                 =>  'Usuwanie starych tematów',
'Days old label'                =>  'Ilość dni wstecz',
'Days old help'                 =>  'Liczba dni wstecz, od których starsze tematy będą czyszczone (np. jeśli wpiszesz 30, każdy temat, w którym ostatni post napisany został więcej niż 30 dni temu, zostanie usunięty).',
'Prune sticky label'            =>  'Usuń przyklejone tematy',
'Prune sticky help'             =>  'Kiedy opcja jest włączona, przyklejone tematy zostaną usunięte z forum.',
'Prune from label'              =>  'Wybierz forum',
'All forums'                    =>  'Wszystkie fora',
'Prune from help'               =>  'Forum, z którego mają zostać usunięte stare tematy.',
'Prune info'                    =>  'Używaj tej funkcji z ostrożnością. <strong>Wyczyszczonych tematów i postów nie można przywrócić.</strong> Dla lepszej wydajności, włącz na forum funkcję %s podczas czyszczenia.',
'Confirm prune subhead'         =>  'Potwierdź czyszczenie forum',
'Confirm prune info'            =>  'Czy jesteś pewny, że chcesz wyczyścić tematy starsze niż %s dni z forum "%s" (%s tematów)?',
'Confirm prune warn'            =>  'OSTRZEŻENIE! Wyczyszczonych postów i tematów nie można przywrócić.',
