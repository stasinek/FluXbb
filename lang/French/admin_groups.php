...
'User title help'			=>	'Ce titre remplacera tout titre que les utilisateurs auraient obtenus dans ce groupe. Laissez vide pour utiliser le titre par défaut ("%s")',
'Promote users label'			=>	'Promouvoir les utilisateurs.',
'Promote users help'			=>	'Vous pouvez promouvoir des utilisateurs dans un nouveau groupe automatiquement après un certain nombre de messages. Sélectionnez "%s" pour désactiver. Pour des raisons de sécurité, vous n\'êtes pas autorisé à sélectionner un groupe "administrateur". Les changements de groupe pour les utilisateurs touchés par ce paramètre prendra effet <strong>immédiatement</strong>. Notez que le nombre de messages que vous entrez est le nombre total des messages d\'un utilisateur, pas le nombre de messages faits en tant que membre de ce groupe.',
