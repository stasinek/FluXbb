...
'Redirect time help'				=>	'Aantal seconden dat een doorverwijspagina wordt getoond. Als dit op 0 staat, wordt deze pagina niet weergeve. Let wel dat de gebruik dan mogelijk nog een pagina te zien krijgt waar geen wijzigingen op zijn aangebracht.',
...
'Verify help'						=>	'Indien aan zullen gebruikers een willekeurig wachtwoord krijgen opgestuurd na hun registratie waarmee ze kunnen inloggen. Daarna kunnen ze hun wachtwoord in hun profiel aanpassen. Dit wordt ook gebruikt om het e-mail adres te wijzigen. Dit is een effectieve manier om ervoor te zorgen dat gebruikers een correct e-mail adres gebruiken.',
...
'Rules help'						=>	'Hier kan je iedere regel die je wilt, of andere informatie die de gebruikers van dit forum moeten weten en accepteren bij hun registratie. Als je bij de vorige optie voor "Ja" hebt gekozen moet je hier iets intypen. De tekst die je hier invult mag HTML bevatten.',
...
'Maintenance message help'			=>	'Het bericht dat bezoekers van het forum zijn als de onderhouds mode actief is. Als je dit veld leeg laat zal een standaard bericht worden weergegeven. De tekst die je hier invult mag HTML bevatten.',
