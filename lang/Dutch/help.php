...
// Taaldefinities gebruikt in help.php
$lang_help = array(
...
'Underlined text'		=>	'Onderlijnde',
'Italic text'			=>	'Schuin gedrukte tekst',
'Strike-through text'	=>	'Doorstreepte tekst',
'Red text'				=>	'Rode tekst',
'Blue text'				=>	'Blauwe tekst',
'Heading text'			=>	'Titel',
'Deleted text'			=>	'Verwijderde tekst',
'Inserted text'			=>	'Gemarkeerde tekst',
...
'Code text'				=>	'Dit is een code.',
'produces code box'		=>	'geeft een code blok als:',

'Nested tags'			=>	'Geneste tags tags',
'Nested tags info'		=>	'BBCode kan worden genest om meer aanpassingen te kunnen doen. Bij voorbeeld:',
'Bold, underlined text'	=>	'Vette en onderlijnde tekst',

'Lists'					=>	'Lijsten',
'List info'				=>	'Om een lijst te maken kan je de list-tag gebruiken. Er zijn 3 verschillende types die je hiermee kan maken.',
'List text 1'			=>	'Voorbeeld lijst item 1.',
'List text 2'			=>	'Voorbeeld lijst item 2.',
'List text 3'			=>	'Voorbeeld lijst item 3.',
'produces list'			=>	'geeft een punt lijst.',
'produces decimal list'	=>	'geeft een genummerde lijst.',
