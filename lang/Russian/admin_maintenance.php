...
$lang_admin_maintenance = array(
    ...
    'Javascript redirect failed'    => 'Переадресация JavaScript не выполнена. %s, чтобы продолжить …',
    'Posts must be integer message' => 'Количество сообщений должно быть положительным целым значением.',
    'Days must be integer message'  => 'Количество дней должно быть положительным целым значением.',
    ...
    'Prune from label'              => 'Что очистить',
    'All forums'                    => 'Все разделы',
    'Prune from help'               => 'Раздел, который вы хотите очистить.',
