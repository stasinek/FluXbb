...
// Report
    ...
    'Reason too long'            => 'Ваше сообщение должно уложиться в 65535 байт (~64kb).',
    'Report flood'               => 'По крайней мере %s секунд должно пройти между жалобами. Пожалуйста, сделайте паузу и попробуйте снова.',
    'Report redirect'            => 'Жалоба отправлена. Переадресация &hellip;',
    'Report post'                => 'Жалоба модератору',
    'Reason'                     => 'Причина обращения',
    'Reason desc'                => 'Пожалуйста, кратко опишите причину, по которой вы создаёте это сообщение',

// Subscriptions
    'Already subscribed topic'   => 'Вы уже подписаны на эту тему.',
    'Already subscribed forum'   => 'Вы уже подписаны на этот раздел.',
    'Subscribe redirect'         => 'Вы подписаны. Переадресация &hellip;',
    'Not subscribed topic'       => 'Вы не подписаны на эту тему.',
    'Not subscribed forum'       => 'Вы не подписаны на этот раздел.',
    'Unsubscribe redirect'       => 'Вы отписаны. Переадресация &hellip;',
...
// Moderate forum
    ...
    'Merge topics redirect'      => 'Темы склеены. Переадресация &hellip;',
    'Confirm merge legend'       => 'Пожалуйста, подтвердите склейку',
